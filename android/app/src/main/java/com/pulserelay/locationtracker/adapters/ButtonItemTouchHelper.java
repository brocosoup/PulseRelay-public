...
/**
 * Helper for drag-and-drop functionality in button sorting
 */
public class ButtonItemTouchHelper extends ItemTouchHelper.Callback {
    
    private final SortableButtonAdapter adapter;
    
    public ButtonItemTouchHelper(SortableButtonAdapter adapter) {
